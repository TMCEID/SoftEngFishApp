...
public class RatingForm extends JFrame {
    ...
    private void saveAction() {
        ...
        if ("Select...".equals(dish) || "Select...".equals(rating)) {
            ...
            try {
                // Create ratings.txt file if it doesn't exist
                File ratingsFile = new File("ratings.txt");

                // Use FileWriter with append mode (true parameter)
                java.io.FileWriter writer = new java.io.FileWriter(ratingsFile, true);
                ...
                printWriter.println("Dish: " + dish);
                printWriter.println("Rating: " + rating);
                printWriter.println("------------------------");
                ...
                showToast("✅ Rating saved! " + dish + " rated " + rating, Color.decode("#059669"));

            } catch (java.io.IOException e) {
                // Handle file writing error
                showToast("❌ Error saving rating: " + e.getMessage(), Color.decode("#DC2626"));
                e.printStackTrace();
            }
        }
    }
